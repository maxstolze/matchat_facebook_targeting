...
class AdManager:
    ...
    def __init__(self, account_id, business_id):
    ...
    def listAllAdsets(self):
        ...
        for c in campaigns:
            adsets.append(c.get_ad_sets([AdSet.Field.id, AdSet.Field.name]))
        return adsets
    ...
    def createAdSet(self, campaign_id):
    ...
    def listAllAds(self):
        ...
        campaigns = self.listAllCampaigns()
        for c in campaigns:
            ads.append(c.get_ads([Ad.Field.id, Ad.Field.name]))
        return ads

    def createAd(self, adset_id, page_id):
    ...
    def createSplitTestAdStudy(self, adset1_id, adset2_id):
